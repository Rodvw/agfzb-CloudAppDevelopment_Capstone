...
# - Call get_request() with specified arguments
# - Get the returned sentiment label such as Positive or Negative
    apikey = 'e8r2LX6usJpAoLCZnwyQJMTwUUKDbbj-2Tc-IutaB7Q2'
    url = 'https://api.au-syd.natural-language-understanding.watson.cloud.ibm.com/instances/3a4fa64a-6f52-44ea-9e0b-d816c1e3fcd7'
